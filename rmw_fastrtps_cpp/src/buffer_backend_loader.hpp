...
#ifndef RMW_FASTRTPS_CPP__BUFFER_BACKEND_LOADER_HPP_
#define RMW_FASTRTPS_CPP__BUFFER_BACKEND_LOADER_HPP_
...
#endif  // RMW_FASTRTPS_CPP__BUFFER_BACKEND_LOADER_HPP_
